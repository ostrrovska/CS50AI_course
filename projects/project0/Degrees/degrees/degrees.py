    ...
    while not frontier.empty():
        ...
        for movie_id, person_id in neighbors_for_person(current_state):
            if person_id == target:
                ...
                path = []
                # Start from the current node (the one connected to target)
                node = current_node
                # The last step is the movie connecting to target
            ...
            if person_id not in came_from:
                came_from[person_id] = (movie_id, current_state)
